                ...
                stage('Build image') {
                    steps {
                        script {
                            ...
                            sh 'wget -O dockerfiles/run/guice/cassandra-rabbitmq/destination/glowroot https://github.com/glowroot/glowroot/releases/download/v0.13.4/glowroot-0.13.4-dist.zip && unzip dockerfiles/run/guice/cassandra-rabbitmq/destination/glowroot -d dockerfiles/run/guice/cassandra-rabbitmq/destination'
