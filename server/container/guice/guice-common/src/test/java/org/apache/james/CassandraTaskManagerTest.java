...
import org.apache.james.task.eventsourcing.cassandra.JsonTaskEventSerializer;
...
class CassandraTaskManagerTest {
    ...
    private static final JsonTaskEventSerializer EVENT_SERIALIZER = new JsonTaskEventSerializer(TASK_SERIALIZER, TasksSerializationModule.MODULES.apply(TASK_SERIALIZER));

    @RegisterExtension
    static CassandraEventStoreExtension eventStoreExtension = new CassandraEventStoreExtension(() -> EVENT_SERIALIZER);
