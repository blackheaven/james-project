...
public class WithPriority extends GenericMailet {
    ...
    private AttributeValue<Integer> priority;
    ...
    public void init() throws MessagingException {
        Integer rawPriority = Optional.ofNullable(getInitParameter("priority", null))
                .map(Integer::valueOf)
        ...
        priority = AttributeValue.of(rawPriority);
    }

    @Override
    public void service(Mail mail) throws MessagingException {
        mail.setAttribute(new Attribute(MailPrioritySupport.MAIL_PRIORITY_ATTRIBUTE_NAME, priority));
    }
}
