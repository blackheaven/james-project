...
class RabbitMQWorkQueueTest {
    ...
    void givenTwoWorkQueuesOnlyTheFirstOneIsConsumingTasks() {
        ...
        verify(taskManagerWorker, new Timeout(1000, times(100))).executeTask(any());

        verify(otherTaskManagerWorker, new Timeout(1000, times(0))).executeTask(any());
    }

    @Test
    void givenANonDeserializableTaskItShouldBeFlaggedAsFailedAndItDoesNoPreventFollowingTasks() throws InterruptedException {
