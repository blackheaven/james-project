...
@ScenarioScoped
public class EncryptedSwiftStepdefs {
    ...
    private final DockerSwiftTestRule swiftServer = CucumberEncryptedSwiftSingleton.encryptedSwiftServer;

    @Inject
    private EncryptedSwiftStepdefs(MainStepdefs mainStepdefs, ImapStepdefs imapStepdefs) {
