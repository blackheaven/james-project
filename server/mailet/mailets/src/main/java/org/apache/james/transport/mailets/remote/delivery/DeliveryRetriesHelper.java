...
public class DeliveryRetriesHelper {
    ...
    public static void initRetries(Mail mail) {
        mail.setAttribute(new Attribute(DELIVERY_RETRY_COUNT, AttributeValue.of(0)));
    }

    public static void incrementRetries(Mail mail) {
        mail.setAttribute(new Attribute(DELIVERY_RETRY_COUNT, AttributeValue.of(retrieveRetries(mail) + 1)));
    }
